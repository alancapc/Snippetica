...
iff|[if not \_](IfNot_.snippet)
ifftp|[if not TryParse \_](IfNotTryParse_.snippet)
ifn|[if equal to null](IfEqualToNull.snippet)
ifnn|[if not equal to null \_](IfNotEqualToNull_.snippet)
...
nn|[not equal to null \_](NotEqualToNull_.snippet)
...
snne|[\!string\.IsNullOrEmpty \_](NotStringIsNullOrEmpty_.snippet)
snnw|[\!string\.IsNullOrWhiteSpace \_](NotStringIsNullOrWhiteSpace_.snippet)
