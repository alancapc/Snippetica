...
namespace Snippetica.CodeGeneration
{
    public static class XmlSnippetGenerator
    {
        ...
        private const string AttributeNameIdentifier = "attributeName";
        private const string AttributeValueIdentifier = "attributeValue";

        private const string CommentIdentifier = "comment";
        private const string ContentIdentifier = "content";
        private const string ElementNameIdentifier = "elementName";
        ...
        {
            s.AddLiteral(AttributeNameIdentifier, "Attribute name", "Attribute");
            s.AddLiteral(AttributeValueIdentifier, "Attribute value", "Value");
        ...
        {
            return new Literal(AttributeNameIdentifier, "Attribute name", "Attribute");
        }

        private static Literal CreateAttributeValueLiteral()
        {
            return new Literal(AttributeValueIdentifier, "Attribute value", "\"\"");
        }
        ...
        {
            return new Literal(ElementNameIdentifier, "Element name", "x");
        }
